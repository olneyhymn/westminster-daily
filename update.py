...
def tweet(a, b):
    ...
    msg = "{base}westminster-daily/{month:0>2}/{day:0>2}"
    url = msg.format(base=base_url, month=month, day=day)

    try:
        # Attempt tweet
        msg = "{}static/images/docs/{:0>2}{:0>2}-full.png"
        image_url = msg.format(file_url, month, day)
