      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .apple-link:hover { background: var(--burgundy); color: var(--cream); text-decoration: none; }
          .section-label {
            text-align: center;
            font-size: 10px;
            letter-spacing: 3px;
        ...
        <div class="page">
          <div class="card">
            <header class="masthead">
              <div class="label">Podcast Feed</div>
              <img class="artwork" alt="">
            ...
            <div class="notice">
              <p style="margin: 0 0 8px 0;">
                <strong>This is a podcast feed.</strong>
                Paste the address below into your podcast app to subscribe.
              </p>
              <code><xsl:value-of select="/rss/channel/atom:link/@href"/></code>
              <div class="readers">
                Works in Apple Podcasts, Overcast, Pocket Casts, Castro, Spotify, and most other players.
              </div>
              <a class="apple-link" href="https://podcasts.apple.com/us/podcast/westminster-daily/id1661869655">Open in Apple Podcasts</a>
            </div>
