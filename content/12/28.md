...
[^fnref:wcf3]: <div class="esv"><h5>Jude 6</h5> <div class="esv-text"><p>And the angels who did not stay within their own position of authority, but left their proper dwelling, he has kept in eternal chains under gloomy darkness until the judgment of the great day—</p> </div> <h5>2 Peter 2:4</h5> <div class="esv-text"><p>For if God did not spare angels when they sinned, but cast them into hell and committed them to chains of gloomy darkness to be kept until the judgment;</p> </div> <p class="copyright-line">(<a href="http://www.esv.org" class="copyright">ESV</a>)</p> </div>
